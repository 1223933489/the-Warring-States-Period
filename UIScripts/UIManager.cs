...
//	public GameObject player;
	...
	public Image tex_SkillCD_Q;
	public Image tex_SkillCD_W;
	public Image tex_SkillCD_E;
	...
	void Start () {
		deathCount = GameObject.Find ("UI/DataPanel/deathCount");
		deathNum = GameObject.Find ("UI/DataPanel/deathCount/Text").GetComponent <Text>();
		...
		tex_SkillCD_Q = transform.Find("OperatePanel/Skill_Q/CD").GetComponent<Image>();
		tex_SkillCD_W = transform.Find("OperatePanel/Skill_W/CD").GetComponent<Image>();
		tex_SkillCD_E = transform.Find("OperatePanel/Skill_E/CD").GetComponent<Image>();
	...
	void Update () {
		...
		if (player != null) {
			...
			tex_SkillCD_Q.sprite = player.skill_Q.tex;
			tex_SkillCD_W.sprite = player.skill_W.tex;
			tex_SkillCD_E.sprite = player.skill_E.tex;
			...
			if (player.IsDeath) {
				...
				deathNum.text =((player .rebirthTime-player.rebTimeCount)).ToString ();
			} else {
				deathCount.SetActive (false);
			}
		}
