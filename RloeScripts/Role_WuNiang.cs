...
public class Role_WuNiang :Role_Main  {
	...
	float atkInterval;
	GameObject skillPrefabE;
	GameObject skillPrefabQ;
	GameObject skillPrefabW;
	public override IEnumerator Start(){
		skillPrefabE = Resources.Load<GameObject> ("TeXiao/WuNiangSkillE");
		skillPrefabQ = Resources.Load<GameObject> ("TeXiao/WuNiangSkillQ");
		skillPrefabW = Resources.Load<GameObject> ("TeXiao/WuNiangSkillW");
	...
	{
		GameObject tmp= Instantiate (skillPrefabQ, transform.position + transform.forward*5, transform.rotation) as GameObject;
		if (tmp != null) {
			tmp.GetComponent<WuNiangSkillQControl> ().camp = this.roleCamp;
			tmp.GetComponent<WuNiangSkillQControl> ().owner = this;
		}
	...
	{
//		GameObject tmp= Instantiate (skillPrefabW, transform.position, transform.rotation) as GameObject;
//		if (tmp != null) {
//			tmp.GetComponent<WuNiangSkillWControl> ().camp = this.roleCamp;
//			tmp.GetComponent<WuNiangSkillWControl> ().owner = this;
//		}
	...
	{
		GameObject tmp= Instantiate (skillPrefabE, transform.position + transform.forward*5, transform.rotation) as GameObject;
		if (tmp != null) {
			tmp.GetComponent<WuNiangSkillEControl> ().camp = this.roleCamp;
			tmp.GetComponent<WuNiangSkillEControl> ().owner = this;
		}
